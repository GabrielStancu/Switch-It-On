...
namespace Switch_It_On_
{
    public partial class Level5 : Form
    {
        ...
        private void bt1_Click(object sender, EventArgs e)
        {
            ...
            if (x % 2 == 1 && y % 2 == 1 && z % 2 == 1 && t % 2 == 1 && s % 2 == 1 && u % 2 == 1)
            {
                Variabile.mutari_lv5 = mutari;
                timer1.Stop();
                Variabile.nivel_actual = 5;
                this.Hide();
        ...
        private void bt3_Click(object sender, EventArgs e)
        {
            ...
            u++;
            if (u % 2 == 0) bt6.BackgroundImage = Properties.Resources.off_button;
            else bt6.BackgroundImage = Properties.Resources.on_button;
